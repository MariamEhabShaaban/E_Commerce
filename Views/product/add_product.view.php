...
<div class="max-w-md mx-auto mt-28 bg-white p-6 rounded-xl shadow-md">
  ...
  <form action="/store_product" method="POST" enctype="multipart/form-data" class="space-y-4">
    ...
    <div>
      ...
      <input type="number" name="price" class="w-full border border-gray-300 p-2 rounded" >
    </div>
